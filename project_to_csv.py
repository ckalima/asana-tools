...
parser.add_argument('-k', '--key', help='Override the default Asana API key.')
parser.add_argument('-p', '--projectid', help='Asana project id to pull tasks from.', required=False)
parser.add_argument('-s', '--start', help='Iteration start date in YYYY-MM-DD.', required=False)
parser.add_argument('-e', '--end', help='Iteration end date in YYYY-MM-DD.', required=False)
...
if args.input:
    ...
    if args.start:
        ...
        start = raw_input("Iteration start date (YYYY-MM-DD): ")
    if args.end:
        end = args.end
    else:
        end = raw_input("Iteration end date (YYYY-MM-DD): ")
elif args.projectid:
